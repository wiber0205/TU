...
public class FriendTimeLineAdapter extends RecyclerView.Adapter implements Response.Listener<String>, Response.ErrorListener {

    protected Context context;
    protected MyVolley myVolley;
    protected ArrayList<TimelineItem> listItemList = new ArrayList<TimelineItem>(); // 데이타
    protected FriendTimeLineAdapter.OnRefreshedListener onRefreshedListener;
    ...
    public RecyclerView.OnScrollListener onScrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (FriendTimeLineAdapter.this.myVolley == null)
                return;

            myVolley = FriendTimeLineAdapter.this.myVolley;
            int lastVisibleItemPosition = ((LinearLayoutManager) recyclerView.getLayoutManager()).findLastCompletelyVisibleItemPosition();
            int itemTotalCount = recyclerView.getAdapter().getItemCount() - 1;

            if (lastVisibleItemPosition == itemTotalCount) {
                String reqIdx = "" + listItemList.get(listItemList.size() - 1).getIdx();
                myVolley.getMyOldTimelineEx(userId, reqIdx, FriendTimeLineAdapter.this, FriendTimeLineAdapter.this);
            }
    ...
    public FriendTimeLineAdapter(Context context, String userId) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        FriendTimeLineAdapter.ViewHolder holder = new FriendTimeLineAdapter.ViewHolder(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        FriendTimeLineAdapter.ViewHolder vh = (FriendTimeLineAdapter.ViewHolder) holder;
    ...
    public void reflash(FriendTimeLineAdapter.OnRefreshedListener onRefreshedListener) {
        this.onRefreshedListener = onRefreshedListener;

        try {
            myVolley.getMyTimelineEx(userId, this, this);
        } catch (Exception e) {
